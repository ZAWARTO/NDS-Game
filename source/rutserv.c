...
void HabilitarInterrupciones() { // In the Interrupt Controller
...
void DefinirVectorInterrupciones() { // Attention routines
...
void InhibirInterrupciones() { // In the Interrupt Controller
